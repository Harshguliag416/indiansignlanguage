...
OUTPUT_DIR = ROOT / "docs" / "hackathon" / "output"
...
def get_current_state() -> dict:
    ...
    alnum_metrics = load_metrics(ROOT / "model_outputs" / "alnum_stage2_bench" / "metrics.json")
    sentence_metrics = load_metrics(ROOT / "model_outputs" / "sentences_bench" / "metrics.json")
